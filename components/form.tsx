...
export function signup() {
  ...
  <div className="fixed inset-0 flex items-center justify-center w-full h-full overflow-hidden">
      ...
      <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Login to learnai if you can because we don&apos;t have a login flow
        yet
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <a
          href="/signin"
          className="group/btn mt-2 relative block h-10 w-full rounded-md bg-gradient-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] flex items-center justify-center"
        >
          Log in →
          <BottomGradient />
        </a>
